...
PUSH_TYPES: list[tuple[str, str, str]] = [
    ...
    ('auto_reply_pending', 'Автоответ ИИ через N мин', 'ИИ сам ответит на позитивный отзыв — можно отменить.'),
    ('auto_reply_sent',    'ИИ ответил гостю',        'Автоответ на позитивный отзыв отправлен.'),
