    ...
    def _ai_generate_view(self, request):
        ...
        if context_type == 'reply':
            ...
            system_prompt = (
                ...
                f'TONE OF VOICE / ИНСТРУКЦИИ:\n{instructions}\n\n'
                'По умолчанию рассылка короткая (~300 символов, 2-4 предложения). Если в черновике пользователь '
                'явно просит написать длиннее — выполни просьбу, до 4000 символов (лимит VK).\n'
