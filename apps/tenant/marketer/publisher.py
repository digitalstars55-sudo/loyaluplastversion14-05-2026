...
wall.post требует ПОЛЬЗОВАТЕЛЬСКИЙ токен админа сообщества (scope wall;
community-токен этот метод не пускает). Токен хранится в
MarketerSettings.vk_wall_token — отдельный от senler-каналов.
