...
def register_or_get_client(
    ...
    *,
    ...
    #   - переход по ссылке RFM-кампании/RF-рассылки (source rfm) — гость лишь
    #     открыл «Мои подарки» из сообщения; засчитать это визитом = метрика
    #     возврата 100% и ложный сброс Recency у всей аудитории кампании;
    ...
    if source not in ('delivery', 'website', 'vk_catalog', 'rfm') and not is_referral_entry:
